...
<head>
    ...
    <title>Créer un compte - BBH</title>
    <link rel="stylesheet" href="ressources graphique/css/register.css">
    ...
    <script src="JS Doc/script.js" defer></script>
    <link href="ressources graphique/css/register.css" rel="stylesheet">
    <link href="ressources graphique/css/styletailwind.css" rel="stylesheet">
</head>

<body class="min-h-screen flex flex-col bg-slate-950 text-slate-200 font-sans">
    ...
    <nav id="sidebar" class="fixed top-0 right-[-100%] w-[75%] sm:w-60 md:w-80 lg:w-96 h-full 
        ...
        <div class="sidebar-login border-t border-gray-700 pt-4 mt-4">
            ...
            <form action="login.php" method="post" class="flex flex-col gap-3">
                ...
                <button type="submit"
                    class="w-full mt-3 p-2 bg-blue-600 text-black font-semibold rounded hover:bg-white transition"
...
<main class="flex-grow flex items-center justify-center p-6 pt-24">
    <div class="w-full max-w-2xl bg-gray-800/90 backdrop-blur p-8 rounded-xl shadow-2xl border border-gray-700">
        
        <h2 class="text-3xl font-bold text-center text-sky-400 mb-6">Création de compte</h2>

        <div class="w-full bg-gray-700 h-2 rounded-full mb-8 relative overflow-hidden">
            <div id="progress" class="bg-sky-500 h-full transition-all duration-300 ease-out" style="width: 0%"></div>
        </div>

        <form id="wizardForm" action="register_action.php" method="POST" novalidate>
            
            <div class="step transition-opacity duration-300">
                <h3 class="text-xl font-semibold text-white mb-4">Informations personnelles</h3>
                
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm text-gray-400 mb-1">Nom d'utilisateur</label>
                        <input type="text" id="displayName" name="displayName" required minlength="3"
                            class="w-full bg-gray-700 border border-gray-600 rounded p-3 text-white focus:border-sky-500 focus:ring-1 focus:ring-sky-500 outline-none transition"
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" required
                            class="w-full bg-gray-700 border border-gray-600 rounded p-3 text-white focus:border-sky-500 outline-none transition"
                ...
                <div class="flex justify-end mt-6">
                    <button type="button" class="next bg-sky-600 hover:bg-sky-500 text-white px-6 py-2 rounded font-semibold transition">
                        Suivant &rarr;
                    </button>
                </div>
            </div>

            <div class="step hidden transition-opacity duration-300">
                <h3 class="text-xl font-semibold text-white mb-4">Sécurité</h3>
                
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm text-gray-400 mb-1">Mot de passe Maître</label>
                        <input type="password" id="masterPassword" name="password" required minlength="8"
                            class="w-full bg-gray-700 border border-gray-600 rounded p-3 text-white focus:border-sky-500 outline-none transition">
                        </div>
                    ...
                    <div>
                        ...
                        <input type="password" id="confirmPassword" required
                            class="w-full bg-gray-700 border border-gray-600 rounded p-3 text-white focus:border-sky-500 outline-none transition">
                        <p id="confirm-msg" class="text-sm mt-1 h-5"></p>
                    </div>
                </div>

                <div class="flex justify-between mt-6">
                    <button type="button" class="prev bg-gray-600 hover:bg-gray-500 text-white px-6 py-2 rounded font-semibold transition">
                        &larr; Précédent
                    </button>
                    <button type="button" class="next bg-sky-600 hover:bg-sky-500 text-white px-6 py-2 rounded font-semibold transition">
                        Suivant &rarr;
            ...
            <div class="step hidden transition-opacity duration-300">
                <h3 class="text-xl font-semibold text-white mb-4">Vérification</h3>
                
                <div class="bg-gray-700/50 p-4 rounded border border-gray-600 space-y-3 text-sm">
                    <p><span class="text-gray-400">Nom :</span> <span id="review-displayName" class="font-bold text-white"></span></p>
                    <p><span class="text-gray-400">Email :</span> <span id="review-email" class="font-bold text-white"></span></p>
                    <p><span class="text-gray-400">Téléphone :</span> <span id="review-phoneNumber" class="font-bold text-white"></span></p>
                    <p><span class="text-gray-400">Mot de passe :</span> <span class="text-green-400">Défini</span></p>
                </div>
                ...
                <div class="flex justify-between mt-6">
                    ...
                    <button type="submit" class="bg-green-600 hover:bg-green-500 text-white px-8 py-2 rounded font-bold shadow-lg transform hover:scale-105 transition">
                        Créer mon compte
                    </button>
                </div>
            </div>
    ...
    <!-- FOOTER -->
    <footer
        class="bg-slate-800/90 backdrop-blur flex flex-col sm:flex-row items-center justify-between mt-14 px-4 py-4 text-sm w-full z-30">
