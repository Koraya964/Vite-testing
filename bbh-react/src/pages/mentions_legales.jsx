...
<body class="h-screen flex flex-col bg-gray-900 text-white relative">
    ...
    <!-- Vidéo en fond -->
    <video autoplay muted loop playsinline preload="metadata" poster="images/background.jpg"
        class="absolute inset-0 w-full h-full object-cover -z-10" alt="bhhbg">
    ...
    <header class="h-16 bg-gray-800/80 backdrop-blur flex items-center justify-between px-4 shadow-md z-20">
        ...
        <nav class="hidden md:flex gap-6" aria-label="Menu navigation header font-sans">
            <a href="index.html" class="hover:text-sky-400 font-bold font-sans">Accueil</a>
            <a href="à_propos.html" class="hover:text-sky-400 font-bold font-sans">À propos</a>
            <a href="Téléchargement.html" class="hover:text-sky-400 font-bold font-sans">Téléchargement</a>
            <a href="contact.html" class="hover:text-sky-400 font-bold font-sans">Contact</a>
            <a href="certification.html" class="hover:text-sky-400 font-bold font-sans">Certification</a>
        </nav>
    ...
    <div id="sidebar-overlay"
        class="fixed inset-0 bg-slate-500 bg-opacity-50 opacity-20 invisible transition-opacity duration-300 z-40">
    </div>
    ...
    <!-- MAIN scrollable -->
    <main class="flex-1 flex items-center justify-center px-4 md:px-8 py-16">
        <section
            class="bg-[#2b3a4a]/70 backdrop-blur-md border border-cyan-400/20 shadow-lg rounded-2xl p-8 w-full max-w-4xl text-gray-100">
            <h1 class="text-3xl font-bold text-center text-cyan-400 mb-10 drop-shadow-lg">
                Mentions légales
            </h1>

            <!-- Bloc 1 -->
            <details class="mb-6 group">
                <summary class="cursor-pointer text-xl font-semibold text-cyan-300 hover:text-cyan-200 transition">
                    1. Éditeur du site
                </summary>
                <div class="mt-3 pl-4 border-l-4 border-cyan-400/30">
                    <p class="mb-2">
                        BBH est un gestionnaire de mots de passe sécurisé, conçu pour aider les utilisateurs à protéger
                        et organiser leurs informations sensibles. Son objectif est de fournir une solution fiable,
                        simple et intuitive pour la gestion quotidienne des mots de passe, tout en mettant l’accent sur
                        la confidentialité , la sécurité des données et son accessibilité.
                    </p>
                    <p>
                        <strong>Nom de l’éditeur :</strong> BBH<br />
                        <strong>Adresse :</strong> adresse communiquée sur demande<br />
                        <strong>E-mail :</strong>
                        <a href="mailto:koraya.contact@gmail.com
                                " class="text-cyan-300 hover:underline">
                            koraya.contact@gmail.com
                        </a>
                    </p>
                </div>
            </details>
            ...
            <details class="mb-6 group">
                ...
                <div class="mt-3 pl-4 border-l-4 border-cyan-400/30">
                    <p>
                        <strong>Nom de l’hébergeur :</strong> Netlify<br />
                        <strong>GitHub du créateur : </strong>
                        <a href="https://github.com/Koraya964/" target="_blank" class="text-cyan-300 hover:underline">
                            https://github.com/Koraya964/
                        </a>
                    </p>
                </div>
            </details>
            ...
            <details class="mb-6 group">
                ...
                <div class="mt-3 pl-4 border-l-4 border-cyan-400/30">
                    <p>
                        <strong>Responsable :</strong> BBH Ecosystems<br />
                        <strong>Contact :</strong>
                        <a href="mailto:koraya.contact@gmail.com" class="text-cyan-300 hover:underline">
                            koraya.contact@gmail.com
                        </a>
                    </p>
                </div>
            ...
            <details class="mb-6 group">
                ...
                <div class="mt-3 pl-4 border-l-4 border-cyan-400/30">
                    <p>
                        Le contenu de ce site (textes, images, code source, etc.) est
                        proposé à titre éducatif. Toute reproduction ou utilisation à des
                        fins commerciales est interdite sans autorisation préalable. Les
                        logos, marques et frameworks mentionnés restent la propriété de
            ...
            <details class="mb-6 group">
                ...
                <div class="mt-3 pl-4 border-l-4 border-cyan-400/30">
                    <p>
                        Ce site ne collecte aucune donnée personnelle et ne dépose aucun
                        cookie de suivi. Aucune information concernant les visiteurs n’est
                        enregistrée ni utilisée à des fins statistiques ou commerciales.
                    </p>
                </div>
            </details>
            ...
            <details class="group">
                ...
                <div class="mt-3 pl-4 border-l-4 border-cyan-400/30">
                    <p>
                        Ce site étant un projet étudiant, l’auteur ne saurait être tenu
                        responsable de toute erreur ou dysfonctionnement pouvant survenir
