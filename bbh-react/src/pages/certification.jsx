...
<body class="bg-gray-900 text-gray-200 min-h-screen flex flex-col">
    ...
    <main class="flex-1 pt-16 px-6 py-8">
        ...
        <div class="cards justify-center flex-wrap gap-6">

            <!-- Titre et intro -->
            <h1 class="text-3xl md:text-4xl text-center text-cyan-500 font-semibold mb-6">
                Nos Certifications
            </h1>
            <p class="text-center max-w-3xl mx-auto mb-10 text-gray-300 text-lg">
                BBH est certifié selon les standards les plus élevés en matière de sécurité, de qualité et de
                conformité.
                Chaque certification atteste de notre engagement envers l’excellence et la fiabilité de nos services.
            </p>
            ...
            <div class="flex flex-wrap justify-center gap-6">
                ...
                <!-- Carte exemple -->
                <div
                    class="bg-slate-800 rounded-xl p-6 shadow-lg flex flex-col items-center text-center w-80 transition-transform transform hover:-translate-y-2 hover:shadow-2xl">
                    <h3 class="text-cyan-500 text-xl font-semibold mb-2">ISO 27001</h3>
                    <p class="text-gray-300 text-sm mb-4">
                        Certification internationale attestant de la sécurité de l’information et de la gestion des
                        risques.
                    </p>
                    <span class="bg-cyan-500/20 text-cyan-500 px-4 py-1 rounded-full text-sm font-bold">
                        Valide
                    </span>
                </div>
                ...
                <div
                    class="bg-slate-800 rounded-xl p-6 shadow-lg flex flex-col items-center text-center w-80 transition-transform transform hover:-translate-y-2 hover:shadow-2xl">
                    <h3 class="text-cyan-500 text-xl font-semibold mb-2">RGPD</h3>
                    <p class="text-gray-300 text-sm mb-4">
                        Conformité avec le Règlement Général sur la Protection des Données pour protéger les
                ...
                <div
                    class="bg-slate-800 rounded-xl p-6 shadow-lg flex flex-col items-center text-center w-80 transition-transform transform hover:-translate-y-2 hover:shadow-2xl">
                    <h3 class="text-cyan-500 text-xl font-semibold mb-2">AWS Security</h3>
                    <p class="text-gray-300 text-sm mb-4">
                        Certification de sécurité sur l’utilisation des services cloud Amazon Web Services.
                    </p>
                    <span class="bg-cyan-500/20 text-cyan-500 px-4 py-1 rounded-full text-sm font-bold">
                        Valide
                    </span>
