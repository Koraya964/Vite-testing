...
<body class="bg-gray-900 text-gray-100 font-sans min-h-screen flex flex-col">
    ...
    <!-- Page Content -->
    <main class="flex-1 container mx-auto p-6 mt-24">
        <section class="max-w-3xl mx-auto bg-gray-800 p-8 rounded-xl shadow-lg">
            <h2 class="text-3xl font-bold text-sky-400 mb-4">Politique de Confidentialité</h2>
            <p class="mb-4 text-gray-300">
                Chez BBH, la protection de vos données personnelles est notre priorité. Nous nous engageons à respecter
                votre
                vie privée et à vous informer de manière transparente sur la manière dont nous collectons, utilisons et
                stockons vos informations.
            </p>

            <h3 class="text-xl font-semibold text-sky-400 mt-6 mb-2">1. Collecte des informations</h3>
            <p class="mb-4 text-gray-300">
                Nous collectons uniquement les informations nécessaires pour le fonctionnement de notre application,
                telles que
                vos identifiants et préférences. Aucune donnée sensible n’est partagée avec des tiers.
            </p>

            <h3 class="text-xl font-semibold text-sky-400 mt-6 mb-2">2. Utilisation des données</h3>
            <p class="mb-4 text-gray-300">
                Les informations collectées servent uniquement à améliorer votre expérience utilisateur, sécuriser vos
                données et
                assurer le bon fonctionnement de l’application BBH.
            </p>

            <h3 class="text-xl font-semibold text-sky-400 mt-6 mb-2">3. Sécurité</h3>
            <p class="mb-4 text-gray-300">
                Nous appliquons des mesures de sécurité robustes pour protéger vos données contre tout accès non
                autorisé,
                divulgation ou perte.
            </p>

            <h3 class="text-xl font-semibold text-sky-400 mt-6 mb-2">4. Droits des utilisateurs</h3>
            <p class="mb-4 text-gray-300">
                Vous avez le droit d’accéder à vos données, de les corriger ou de demander leur suppression. Pour
                exercer ces
                droits, contactez notre support via l’application.
            </p>
