...
<body class="bg-gray-900 text-gray-200 min-h-screen flex flex-col">
    ...
    <header class="h-16 bg-gray-800/80 backdrop-blur flex items-center justify-between px-4 shadow-md z-20">
        ...
        <nav class="hidden md:flex gap-6" aria-label="Menu navigation header font-sans">
            <a href="index.html" class="hover:text-sky-400 font-bold font-sans" aria-label="Retour à l'accueil">Accueil</a>
    ...
    <!-- Main Content -->
    <main class="flex-1 mt-16 px-6 py-8 space-y-8">
        <section class="text-center max-w-4xl mx-auto">
            <h1 class="text-3xl md:text-4xl text-cyan-500 mb-6 font-semibold">À propos de BBH</h1>
            <div class="bg-gray-800 p-6 rounded-xl shadow-lg space-y-4 text-left">
                <h3 class="text-xl text-sky-400 mb-2 border-l-4 border-sky-500 pl-2">Qui sommes-nous ?</h3>
                <p>BBH (Bug Bounty Hero) est une solution open-source qui combine un gestionnaire de mots de passe
                    robuste avec un connecteur VPN intégré. Notre objectif est de simplifier la cybersécurité pour tous
                    : particuliers, entreprises et passionnés de technologie.</p>
            </div>

            <div class="bg-gray-800 p-6 rounded-xl shadow-lg space-y-4 text-left">
                <h3 class="text-xl text-sky-400 mb-2 border-l-4 border-sky-500 pl-2">Nos valeurs</h3>
                <ul class="list-disc pl-6 space-y-1">
                    <li>Sécurité avant tout</li>
                    <li>Respect de la vie privée</li>
                    <li>Simplicité et performance</li>
                    <li>Open-source et communauté</li>
                    <li>Des solutions locales sans passer par le réseau</li>
                </ul>
            </div>

            <div class="bg-gray-800 p-6 rounded-xl shadow-lg space-y-4 text-left">
                <h1 class="text-2xl text-cyan-400 mb-3 font-semibold text-center">Fonctionnalités & architecture</h1>
                <p class="text-gray-300 italic text-center mb-4">Résumé des composants techniques recommandés et des
                    choix réalisables pour la mise en œuvre backend.</p>

                <!-- Sections techniques -->
                <div class="space-y-6">
                    <section class="space-y-2">
                        <h3 class="text-xl text-sky-400 mb-2 border-l-4 border-sky-500 pl-2">Vaults & chiffrement des
                            secrets</h3>
                        <p>Approche recommandée : <strong>zero-knowledge client-side encryption</strong> : les mots de
                            passe sont chiffrés côté client avant d'arriver sur le serveur...</p>
                        <ul class="list-disc pl-6 space-y-1">
                            <li><strong>Lib crypto recommandée :</strong> <code>libsodium</code></li>
                            <li><strong>Derivation de clé :</strong> Argon2</li>
                            <li><strong>Stockage :</strong> ciphertext + metadata</li>
                        </ul>
                    </section>

                    <section class="space-y-2">
                        <h3 class="text-xl text-sky-400 mb-2 border-l-4 border-sky-500 pl-2">Authentification & MFA</h3>
                        <p>Mise en place d’authentification robuste : gestion de sessions sécurisées + 2FA TOTP...</p>
                        <ul class="list-disc pl-6 space-y-1">
                            <li><strong>TOTP (2FA) :</strong> standard RFC 6238</li>
                            <li><strong>Bonne pratique fédérale :</strong> suivre NIST SP 800-63B</li>
                            <li><strong>OAuth2 / OIDC :</strong> si besoin de delegations / SSO</li>
                        </ul>
                    </section>

                    <section class="space-y-2">
                        <h3 class="text-xl text-sky-400 mb-2 border-l-4 border-sky-500 pl-2">Connecteur VPN</h3>
                        <p>Recommandé d’utiliser <strong>WireGuard</strong> : moderne, léger, performant et simple à
                            auditer...</p>
                        <ul class="list-disc pl-6 space-y-1">
                            <li>Gestion des clés : paire clé publique/privée par utilisateur</li>
                            <li>UI : bouton « Générer / Télécharger »</li>
                            <li>Optionnel : WireGuard Portal</li>
                        </ul>
                    </section>

                    <section class="space-y-2">
                        <h3 class="text-xl text-sky-400 mb-2 border-l-4 border-sky-500 pl-2">Transport & TLS</h3>
                        <p>TLS obligatoire partout. Let's Encrypt pour automatiser l'émission/renouvellement des
                            certificats.</p>
                    </section>

                    <section class="space-y-2">
                        <h3 class="text-xl text-sky-400 mb-2 border-l-4 border-sky-500 pl-2">Stockage des mots de passe
                            & recommandations</h3>
                        <p>Ne pas stocker de mot de passe en clair. Utiliser Argon2 et suivre les recommandations OWASP.
                        </p>
                    </section>

                    <section class="space-y-2">
                        <h3 class="text-xl text-sky-400 mb-2 border-l-4 border-sky-500 pl-2">Observabilité & sécurité
                            opérationnelle</h3>
                        <ul class="list-disc pl-6 space-y-1">
                            <li>Logs d’audit anonymisés</li>
                            <li>Pipeline CI/CD sécurisé</li>
                            <li>Mises à jour signées pour le client</li>
                        </ul>
                    </section>

                    <section class="space-y-2">
                        <h3 class="text-xl text-sky-400 mb-2 border-l-4 border-sky-500 pl-2">Architecture cible (résumé)
                        </h3>
                        <ol class="list-decimal pl-6 space-y-1">
                            <li>Frontend web / Electron (UI)</li>
                            <li>Backend API</li>
                            <li>DB chiffrée (Postgres)</li>
                            <li>Auth : sessions + TOTP + OAuth2/OIDC</li>
                            <li>Transport : TLS + VPN WireGuard</li>
                        </ol>
                    </section>

                    <section class="space-y-2">
                        <h3 class="text-xl text-sky-400 mb-2 border-l-4 border-sky-500 pl-2">Ressources & sources</h3>
                        <ul class="list-disc pl-6 space-y-1">
                            <li>Libsodium</li>
                            <li>Argon2</li>
                            <li>WireGuard</li>
    ...
    <footer
        ...
        <div class="flex items-center gap-3 mt-2 sm:mt-0">
            <a href="mentions_legales.html" class="hover:text-sky-400" aria-label="Mentions légales">Mentions légales</a>
            <a href="politique_de_confidentialité.html" class="hover:text-sky-400" aria-label="Confidentialité">Confidentialité</a>
